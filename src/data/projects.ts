...
export const projects: Project[] = [
  ...
  {name:"PANet",code:"PANET",description:"Сеть, в которой ИИ-агенты находят людей и устройства для выполнения задач в физическом мире.",status:"BUILDING",accent:"violet",href:"https://github.com/Ldiga174/Physical-agent-network",domain:"panet.ldiga.com",tags:["Agents","Network","Web3"]},
